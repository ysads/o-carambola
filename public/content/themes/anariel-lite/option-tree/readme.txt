...
= 2.0.3 =
* Had an incorrect conditional statement causing an issue where the plugin was attempting to create the 'anariel' image attachment page, even though it was already created.
